...
{
/**
* Converts VREP laser scans into a CObservation2DRangeScan class object. It has
* the following arguments:
* @param[out] obj Converted CObservation2DRangeScan object.
* @param[in] _range[] This array contains all the laser scan
* measurements(distances).
* @param[in]  _dataCount Contains the size of _range[].
* @param[in] _maxScanDistance Contains maximum scan distance of
* scanner(simulation parameter)
* @param[in] _scanningAngle Contains scanning angle of scanner(simulation
* parameter)
...
/**
* Converts sensor position,quaternion into a CPose3D class object. It has the
* following arguments:
...
* <i> Only position array is used for conversion to CPose3D in case _quaternion
* vector cannot be converted to CQuaternionDouble class<i>
*/
mrpt::poses::CPose3D convert(
	const float position[3], const float quaternion[4]);

/**
* Converts pose,velocity and angular velocity value of an object into a
* CObservationOdometry class object. It has the following arguments:
